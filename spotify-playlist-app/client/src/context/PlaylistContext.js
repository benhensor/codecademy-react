...
export const PlaylistProvider = ({ children }) => {
  ...
  const createPlaylist = async (name) => {
    ...
    try {
      ...
      setError(error.response?.data?.error?.message || 'Error creating playlist');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <PlaylistContext.Provider value={{ playlist, addToPlaylist, removeFromPlaylist, createPlaylist, loading, error, success }}>
      {children}
