...
import NewPlaylist from './icons/NewPlaylist'
...
export default function Display() {
    ...
    const filterResults = (filter) => {
      ...
      switch (filter) {
        case 'artists':
          setFilteredResults(searchResults.filter(item => item.type === 'artist'));
          break;
        case 'songs':
          setFilteredResults(searchResults.filter(item => item.type === 'track'));
          break;
        case 'albums':
          setFilteredResults(searchResults.filter(item => item.type === 'album'));
          break;
        default:
				...
				<StyledDisplay>
					<Header>
						...
						<Controls>
							...
							<NewPlaylist onClick={() => handleShowPlaylist()}/>
						</Controls>
					</Header>
					<ContentContainer $showPlaylist={showPlaylist}>
            <SearchResults results={filteredResults} />
            {showPlaylist && <PlaylistContainer><Playlist /></PlaylistContainer>}
          </ContentContainer>
				</StyledDisplay>
			)}
		</>
